/* https://community.topcoder.com/stat?c=problem_statement&pm=1768 */

public class MarginCalculator{
	public int percent(String[] items){

		double actualCostSum = 0.0;
		double pricePaidSum = 0.0;
		...
		diff = (100 * (pricePaidSum - actualCostSum))/pricePaidSum;///actualCostSum;

		//System.out.println(diff+" "+pricePaidSum+" "+actualCostSum);
